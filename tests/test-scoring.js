...
function calculateGrandTotal(team1TotalPins, team2TotalPins, teamGamePointsPerWin = 2) {
  if (team1TotalPins > team2TotalPins) {
...
const tests = [
  ...
  },
  {
    ...
    test: () => {
      ...
      const grand = calculateGrandTotal(1620, 1580, teamGamePointsPerWin);
