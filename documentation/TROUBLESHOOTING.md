...
- Verify point configuration (gameWinPoints, matchWinPoints, grandTotalPoints)
...
- When both players in a game are absent, it's always a draw (50% of gameWinPoints to each)
