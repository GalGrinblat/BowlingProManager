...
אזור הניהול מספק שליטה מלאה על ארגון הבאולינג — ליגות, עונות, קבוצות, שחקנים, ניקוד, לוח משחקים וניהול משתמשים.
