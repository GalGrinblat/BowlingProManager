...
import type { Game, League, Season, Team, TeamStanding, PlayerStats, CurrentPlayerAverages, ScheduleMatchDay } from '../../../types/index';
...
export const PrintCombined: React.FC<PrintCombinedProps> = ({
  ...
  const loadData = async () => {
    ...
    // Calculate current averages (up to this matchday) for match day section
    if (includeMatchDay) {
