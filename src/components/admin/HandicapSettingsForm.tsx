...
interface HandicapSettingsFormProps {
  useHandicap: boolean;
...
/**
 * Shared Handicap Settings Form Component
 * Used in both LeagueManagement and SeasonCreator for consistent handicap configuration
 */
export const HandicapSettingsForm: React.FC<HandicapSettingsFormProps> = ({
  useHandicap,
  handicapBasis,
  handicapPercentage,
  onUseHandicapChange,
  ...
  return (
    <div className="border-t pt-4 mt-4">
      <h3 className="text-lg font-bold text-gray-800 mb-3">{t('leagues.handicap.settings')}</h3>
      {showDescription && (
        <p className="text-sm text-gray-600 mb-3">
          {t('leagues.handicap.settingsDesc')}
        </p>
      )}
