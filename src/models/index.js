...
export const createLeague = ({
  ...
  dayOfWeek,
  lineupStrategy: ['flexible', 'fixed', 'rule-based'].includes(lineupStrategy) ? lineupStrategy : 'flexible',
  lineupRule: ['standard', 'balanced'].includes(lineupRule) ? lineupRule : 'standard',
