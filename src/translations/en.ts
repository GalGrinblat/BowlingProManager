...
const en: TranslationDictionary = {
  ...
  leagues: {
    ...
    handicapSettingsDesc: 'Configure handicap rules to level the playing field between players of different skill levels',
    ...
    playerMatchPointsPerWin: 'Individual Game Win Points',
    playerMatchPointsPerWinDesc: 'Points for winning an individual player vs player game',
    teamMatchPointsPerWin: 'Match Winner Points',
    ...
    lineupStrategy: 'Lineup Strategy',
    lineupStrategyTitle: 'Player Matchup Strategy',
    lineupStrategyDesc: 'Configure how player matchups (1v1, 2v2, etc.) are determined for games',
    lineupStrategyLabel: 'Lineup Strategy',
    lineupFlexible: 'Flexible Lineup - Can adjust before each match',
    lineupFixed: 'Fixed Lineup - Set once at game start',
    lineupRuleBased: 'Rule-Based Lineup - Determined by player ranking',
    lineupFlexibleDesc: 'Lineup can be modified before each of the 3 matches',
    lineupFixedDesc: 'Lineup is locked after initial setup',
    lineupRuleBasedDesc: 'Lineup automatically determined by player averages',
