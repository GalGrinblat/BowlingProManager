...
CREATE TABLE public.leagues (
  ...
  name TEXT NOT NULL,
  description TEXT,
  default_number_of_teams INTEGER NOT NULL,
  default_players_per_team INTEGER NOT NULL,
  default_number_of_rounds INTEGER NOT NULL,
  default_matches_per_game INTEGER NOT NULL,
  day_of_week TEXT NOT NULL,
  lineup_strategy lineup_strategy,
  lineup_rule lineup_rule,
  ...
  default_handicap_basis INTEGER NOT NULL,
  handicap_percentage INTEGER NOT NULL,
  team_all_present_bonus_enabled BOOLEAN DEFAULT FALSE,
  team_all_present_bonus_points INTEGER,
