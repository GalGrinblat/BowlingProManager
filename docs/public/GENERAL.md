...
3. ראה את התוצאות המלאות משחק אחר משחק עם ניקוד, הנדיקאפ ופירוט הנקודות לכל שחקן וקבוצה.
...
4. **שלב 2**: הזן את סך הפינים לכל שחקן, משחק אחר משחק.
5. **שלב 3**: סקור את כל הניקוד ולחץ **שלח**.
6. המנהל סוקר את ההגשה בלוח הניהול ומאשר אותה.
